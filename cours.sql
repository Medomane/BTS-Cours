...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Cours`.`users` (`id` INT, `firstName` INT, `lastName` INT, `email` INT, `password` INT, `activated` INT, `registredAt` INT, `role` INT, `type` INT, `gender` INT, `establishment_id` INT, `semester_id` INT, `lineBranch_id` INT, `establishment` INT, `abbreviated` INT, `branch` INT, `semester` INT);
...
SELECT u.*,e.name establishment,b.abbreviated,b.name branch, s.semester 
...
union ALL
SELECT u.*,e.name establishment,'' abbreviated,'' branch, '' semester 
...
START TRANSACTION;
USE `Cours`;
INSERT INTO `Cours`.`user` (`id`, `firstName`, `lastName`, `email`, `password`, `activated`, `registredAt`, `role`, `type`, `gender`, `establishment_id`, `semester_id`, `lineBranch_id`) VALUES (1, 'med', 'Hammane', 'med@gmail.com', '25d55ad283aa400af464c76d713c07ad', 1, DEFAULT, 0, 'student', 0, 1, 3, 39);
INSERT INTO `Cours`.`user` (`id`, `firstName`, `lastName`, `email`, `password`, `activated`, `registredAt`, `role`, `type`, `gender`, `establishment_id`, `semester_id`, `lineBranch_id`) VALUES (2, 'abdelkbir', 'Mahha', 'mahha@gmail.com', '25d55ad283aa400af464c76d713c07ad', 1, DEFAULT, 1, 'professor', 0, 1, DEFAULT, DEFAULT);
...
INSERT INTO `Cours`.`lineTeaching` (`id`, `user_id`, `lineModule_id`, `establishment_id`) VALUES (4, 2, 4, 1);
INSERT INTO `Cours`.`lineTeaching` (`id`, `user_id`, `lineModule_id`, `establishment_id`) VALUES (5, 2, 5, 1);
INSERT INTO `Cours`.`lineTeaching` (`id`, `user_id`, `lineModule_id`, `establishment_id`) VALUES (6, 2, 6, 1);
INSERT INTO `Cours`.`lineTeaching` (`id`, `user_id`, `lineModule_id`, `establishment_id`) VALUES (7, 2, 7, 1);
