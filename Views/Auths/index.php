<style>
    ...
    *::after {
    ...
    background: linear-gradient(to bottom, rgba(92, 77, 66, 0.8) 0%, rgba(92, 77, 66, 0.8) 100%), url("<?=WEBROOT."img/bg-masthead.jpg" ?>");
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto my-2 my-lg-0 ">
                ...
                <li class="nav-item"><a  class="nav-link" target="_blank" data-value="Referentials" href="https://e-bts.men.gov.ma/Fr/Organistation/Pages/R%C3%A9f%C3%A9rentiels%20de%20formation.aspx">Referentials</a></li>
            </ul>
        </div>
    </div>
</nav>
        ...
        <div class="container h-100">
            <div class="row h-100 align-items-center justify-content-center text-center">
                <div class="col-lg-10 align-self-end">
                    <h1 class="text-uppercase text-white font-weight-bold">BTS MAROC</h1>
                    <hr class="divider my-4" />
                </div>
                <div class="col-lg-8 align-self-baseline">
                    <p class="text-white-75 font-weight-light mb-5">upload and download files easily by any branch or unity or module</p>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    ...
                    <p class="text-white-50 mb-4">everything you need to get your lesson up and running in no time! free to download, and easy to use! </p>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="mt-5">
                        ...
                        <h3 class="h4 mb-2">Download files</h3>
                        <p class="text-muted mb-0"></p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="mt-5">
                        <i class="fas fa-4x fa-file-upload text-primary mb-4"></i>
                        <h3 class="h4 mb-2">Upload files</h3>
                        <p class="text-muted mb-0"></p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 text-center">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 ml-auto text-center mb-5 mb-lg-0">
                    ...
                    <div>+212 6 84 75 69 19</div>
                </div>
                <div class="col-lg-4 mr-auto text-center">
                    <i class="fas fa-envelope fa-3x mb-3 text-muted"></i>
                    <!-- Make sure to change the email address in BOTH the anchor text and the link target below!-->
                    <a class="d-block" style="text-decoration:none;color:black;" href="mailto:said.hammane1@gmail.com">Gmail</a>
                </div>
            </div>
        </div>
    </section>
